...
PRO driver_an_2022fThresholds_vrn_forFig_zoom
  ;

  datapath = 'e:\OneDrive - University of Iowa\bDocs\expAnalysisBackup\c_14226_vid56\20220615forP_2022fThresholds_fig\08_code_an_2022fThresholds_vrn_forFig_zoom\'

  curDate='20220615'
  print, curDate
  print, datapath
  coreName = STRCOMPRESS('voronoiMap_zoom' + STRING(curDate) + 'ff_', /REMOVE_ALL)
  ;ROI
;  leftBorder = 600.0d
;  rightBorder= 1000.0d;
;  yMin = 0.0d;
